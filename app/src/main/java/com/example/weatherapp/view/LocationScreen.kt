package com.example.weatherapp.view
    ...
    import com.example.weatherapp.ui.theme.md_theme_light_inversePrimary
    ...
    import com.example.weatherapp.util.celciusConverter
    import com.example.weatherapp.util.saveLastLocation
    import com.example.weatherapp.util.getLastLocation
    import com.example.weatherapp.ui.theme.md_theme_light_primary
    ...
    fun CurrentLocationScreen() {
                ...
                fusedLocationClient.lastLocation
                    .addOnSuccessListener { location: Location? ->
                        location?.let {
                            ...
                            viewModel.getWeather(latitude, longitude, ApiStringDetails.APIKEY)
                            query = ""
        ...
        val displayLocationWeather: (Double, Double) -> Unit = { lat, lon ->
            viewModel.getWeather(lat, lon, ApiStringDetails.APIKEY)
            query = ""
...
// Retrieve the last location used (if any)
        ...
        if (lastLocation != null) {
            LaunchedEffect(lastLocation) {
                ...
                viewModel.getWeather(lastLocation.first, lastLocation.second, ApiStringDetails.APIKEY)
            }
        }
        ...
        Column {
            ...
            if (query.isNotBlank()) {
                viewModel.getLocation(query, ApiStringDetails.APIKEY)
                LazyColumn {
                    items(search) { item ->
